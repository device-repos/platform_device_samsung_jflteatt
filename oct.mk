...
PRODUCT_BUILD_PROP_OVERRIDES += PRODUCT_NAME=jflteatt TARGET_DEVICE=jflteatt BUILD_FINGERPRINT="samsung/oct_jflteatt/jflteatt:4.4/KRT16O/user/release-keys" PRIVATE_BUILD_DESC="jflteatt-user 4.4 KRT16O release-keys"
